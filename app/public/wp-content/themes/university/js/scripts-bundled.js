  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join(''), "\n                    ").concat(results.generalInfo.length ? '</ul>' : '', "\n                </div>\n                \n                <div class=\"one-third\">\n                    <h2 class=\"search-overlay__section-title\">Programs</h2>\n                    ").concat(results.programs.length ? '<ul class="link-list min-list">' : "<p>No programs matches this search. <a href=\"".concat(universityData.root_url, "/programs\">View all programs</a></p>"), "\n                    ").concat(results.programs.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a></li>");
        }).join(''), "\n                    ").concat(results.programs.length ? '</ul>' : '', "\n                    \n                    <h2 class=\"search-overlay__section-title\">Professors</h2>\n                    ").concat(results.professors.length ? '<ul class="professor-cards">' : "<p>No professors matches this search.</p>", "\n                    ").concat(results.professors.map(function (item) {
  ...
  _createClass(MyNotes, [{
    ...
    value: function createNote(e) {
      ...
      _jquery.default.ajax({
        ...
        error: function error(response) {
          if (response.responseText == "You've reached your post limit") {
